  ...
  return (
    <div className='container mx-auto p-6'>
      ...
      <div className="grid grid-flow-col grid-rows-3 gap-4">
        ...
        <div className="row-span-1 lg:row-span-3   bg-blue-400 p-8 flex flex-col items-center justify-center rounded-lg shadow-md">
          <h1 className='text-3xl font-bold text-black'>44.5k</h1>
          <p className='text-black'>Remote Jobs</p>
        </div>

        {/* Second box: spans 2 columns */}
        <div className="row-span-1 lg:col-span-2 bg-[#BEAFFE] p-8 flex flex-col items-center justify-center rounded-lg shadow-md">
          <h1 className='text-3xl font-bold text-black'>35k</h1>
          <p className='text-black'>Full-time Jobs</p>
        </div>

        {/* Third box: spans 2 columns & 2 rows */}
        <div className="row-span-1 lg:col-span-2 lg:row-span-2 bg-[#FFD6AD] p-8 flex flex-col items-center justify-center rounded-lg shadow-md">
